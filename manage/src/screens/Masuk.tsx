...
/**
 * Gerbang masuk aplikasi manajemen ruang.
 *
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-navy-50 p-6">
      <form onSubmit={kirim} className="w-full max-w-[420px] rounded-2xl border border-line bg-white p-8 shadow-sm">
        <h1 className="text-[22px] font-bold text-navy-800">Manajemen Outlet</h1>
        <p className="mt-1 text-[13px] text-ink-400">Nalarasa OS · masuk untuk melihat denah sebenarnya</p>
