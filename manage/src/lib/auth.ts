...
const KEY = { token: 'manage.token', nama: 'manage.user', kedaluwarsa: 'manage.exp' };
...
export function sesi(): Sesi | null {
  ...
  // supervisor tidak boleh menekan tombol dan baru tahu sesinya habis.
